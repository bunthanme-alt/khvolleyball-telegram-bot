...
# 🌟 កែសម្រួលប្រព័ន្ធ /shuffle ឱ្យមានបន្ទាត់ខណ្ឌកណ្តាលរចនាប័ទ្ម ——————Vs—————— 🌟
...
async def info_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    info_msg += "💡 លក្ខខណ្ឌ៖ ថ្លៃតុងចែកស្មើគ្នា ថ្លៃទឹកសុទ្ធ/ទឹកអំពៅ/ភេសជ្ជៈទាំងអស់ ក្រុមចាញ់ជាអ្នកចេញ biographies ។"
